...
Applicant applicant2 = new() { FullName = "Михалков Михаил Михайлович", ClassNumber = 11, AverageScore = 5.00 };
...
PowerfullRandom powerfullRandom = new();
Console.WriteLine(powerfullRandom.NextString(10));
